...
#[case(
    ...
    "abc,mno,yz",
    AsciiChar::Comma,
    Err(SearchError::NotFound(Span(0, 3)))
)]
#[case(
    "a",
    "abc,def,yz",
...
#[case(
    ...
    "abc,def,yz",
    AsciiChar::Comma,
    Err(SearchError::NotFound(Span(8, 10)))
)]
...
#[case(
    ...
    "abc,def,yz",
    AsciiChar::Comma,
    Err(SearchError::NotFound(Span(4, 7)))
)]
#[case(
    "zyz",
    "abc,def,yz",
...
#[case(
    ...
    "a,b,c",
    AsciiChar::Comma,
    Err(SearchError::NotFound(Span(0, 1)))
)]
...
#[case("d", "a,b,c", AsciiChar::Comma, Err(SearchError::NotFound(Span(4, 5))))]
...
#[case("", "abc", AsciiChar::Comma, Err(SearchError::NotFound(Span(0, 3))))]
...
#[case("abc", ",", AsciiChar::Comma, Err(SearchError::NotFound(Span(0, 0))))]
